...
<main class="bg-background min-h-screen font-body text-secondary_text">
    ...
    <div>
        <button id="increaseFontBtn" class="fixed bottom-6 z-20 right-6 bg-primary hover:bg-primary_hover text-white font-semibold py-2.5 px-4 rounded-full shadow-md focus:outline-none focus:ring-2 focus:ring-accent transition" aria-label="Povećaj font">
            A+
        </button>
    </div>
    ...
    <section class="relative pt-28 pb-16 bg-secondary_background border-b border-secondary/30 text-center">
        <div class="container mx-auto px-4">
            <h1 class="text-4xl md:text-5xl font-heading font-extrabold text-primary_text mb-3 tracking-tight"><?= htmlspecialchars($dynamicText['t_misija-i-vizija_a7821c_b1affe']['text'] ?? 'Misija i Vizija', ENT_QUOTES, 'UTF-8'); ?></h1>
            <p class="text-lg md:text-xl text-secondary_text/80 max-w-2xl mx-auto"><?= htmlspecialchars($dynamicText['t_misija-i-vizija_aa1872_3a5837']['text'] ?? 'Načela koja nas vode i ciljevi kojima težimo.', ENT_QUOTES, 'UTF-8'); ?></p>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div class="bg-surface border border-secondary/20 rounded-2xl p-10 transition">
                <header class="border-b border-secondary/30 pb-4 mb-6">
                    <h2 class="text-3xl font-heading font-semibold text-primary mb-2"><?= htmlspecialchars($dynamicText['t_misija-i-vizija_1ba6c9_993f03']['text'] ?? 'Naša Misija', ENT_QUOTES, 'UTF-8'); ?></h2>
                    <p class="text-secondary_text/70 text-sm uppercase tracking-widest font-medium"><?= htmlspecialchars($dynamicText['t_misija-i-vizija_f1dae3_a5e3b1']['text'] ?? 'Svrha i posvećenost', ENT_QUOTES, 'UTF-8'); ?></p>
                </header>
            ...
            <div class="bg-surface border border-secondary/20 rounded-2xl p-10 transition">
                <header class="border-b border-secondary/30 pb-4 mb-6">
                    <h2 class="text-3xl font-heading font-semibold text-accent mb-2"><?= htmlspecialchars($dynamicText['t_misija-i-vizija_041847_d99b3f']['text'] ?? 'Naša Vizija', ENT_QUOTES, 'UTF-8'); ?></h2>
                    <p class="text-secondary_text/70 text-sm uppercase tracking-widest font-medium"><?= htmlspecialchars($dynamicText['t_misija-i-vizija_63472f_663ed2']['text'] ?? 'Pogled ka budućnosti', ENT_QUOTES, 'UTF-8'); ?></p>
                </header>
                <div class="text-secondary_text leading-relaxed prose prose-neutral max-w-none text-justify text-[1.05rem]">
                    <?= $vision ?>
                </div>
