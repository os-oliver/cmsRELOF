...
<main class="bg-background pt-12 min-h-screen font-body text-secondary_text">
    <section class="container mx-auto px-4 py-12">
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-primary_text font-heading mb-2"><?= htmlspecialchars($dynamicText['t_vesti_31a2b3_fad594']['text'] ?? 'Vesti', ENT_QUOTES, 'UTF-8'); ?></h1>
            <p class="text-lg text-secondary_text"><?= htmlspecialchars($dynamicText['t_vesti_10263c_7c9b57']['text'] ?? 'Istražite našu bogatu ponudu kulturnih događaja', ENT_QUOTES, 'UTF-8'); ?></p>
        </div>
