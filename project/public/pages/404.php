...
<head>
  ...
  <style>
    body {
      ...
      overflow: hidden;
      /* Hide overflow from background elements */
    }
...
<body class="relative">
  <!-- Background Details -->
  <div class="background-shape w-96 h-96 bg-indigo-200" style="top: -10%; left: -5%;"></div>
  <div class="background-shape w-80 h-80 bg-violet-200" style="bottom: -15%; right: -5%;"></div>
  ...
  <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative z-10">
    <div class="w-full min-h-screen flex flex-col justify-center items-center py-12">
      ...
      <div class="browser-window w-full bg-white border border-gray-200/80 rounded-xl">
        <!-- Top bar -->
        <div class="p-4 flex justify-between items-center border-b border-gray-200/80">
          <div class="flex items-center space-x-2">
            <!-- Changed dot colors to gray -->
            <span class="w-3.5 h-3.5 bg-gray-200 rounded-full block"></span>
            <span class="w-3.5 h-3.5 bg-gray-200 rounded-full block"></span>
            <span class="w-3.5 h-3.5 bg-gray-200 rounded-full block"></span>
          </div>
          <div class="bg-gray-100 text-gray-600 text-sm rounded-md px-4 py-1 flex-grow max-w-md text-center">
            sajt.com/stranica-koja-ne-postoji
          </div>
          <div class="w-20"></div> <!-- Spacer -->
        </div>

        <!-- Main content -->
        <div class="relative py-16 px-6 flex justify-center items-center flex-col">
          <!-- Illustration -->
          ...
          <div class="block text-center mt-4">
            <h1 class="md:text-2xl text-xl leading-8 text-gray-800 font-bold mb-2">
              <span class="text-indigo-600">Ups!</span> Stranica nije pronađena
            </h1>
            <p class="text-gray-500 max-w-md mx-auto">
              Izgleda da stranica koju tražite ne postoji, premeštena je na drugu lokaciju ili je trenutno nedostupna.
            </p>
            <a href="/"
              class="mt-8 inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg shadow-indigo-500/30">
              Početna stranica
            </a>
          </div>
        </div>
