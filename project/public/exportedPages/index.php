...
<html lang="en">
<head>
    <link rel="icon" type="image/png" href="/assets/icons/CentarZaKulturu.png">

    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>CentarZaKulturu</title>
...
<?php require_once __DIR__ . '/landingPageComponents/landingPage/header.php'; ?></style>
</head>
<div class="min-h-screen flex flex-col">
<main class="flex-grow">
<?php require_once __DIR__ . '/landingPageComponents/landingPage/divmobileMenu.php'; ?>
<?php require_once __DIR__ . '/landingPageComponents/landingPage/divicydp.php'; ?>
<?php require_once __DIR__ . '/landingPageComponents/landingPage/i9ckh8.php'; ?>
<?php require_once __DIR__ . '/landingPageComponents/landingPage/diviqqav4.php'; ?>
