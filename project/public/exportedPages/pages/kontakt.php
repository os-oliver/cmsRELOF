...
?>
    ...
    <title><?= htmlspecialchars($dynamicText['t_kontakt_61a206_fa84f0']['text'] ?? 'kontakt', ENT_QUOTES, 'UTF-8'); ?></title>
...
<div class="py-12 mt-20 px-4 flex-1">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="text-center mb-16">
                <h1 class="text-5xl font-bold text-gray-800 mb-6 bg-gradient-to-r from-orange-600 to-blue-600 bg-clip-text text-transparent"><?= htmlspecialchars($dynamicText['t_kontakt_76887f_e42ffd']['text'] ?? 'Kontaktirajte nas', ENT_QUOTES, 'UTF-8'); ?></h1>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed"><?= htmlspecialchars($dynamicText['t_kontakt_ffb33d_091dff']['text'] ?? 'Vaše mišljenje nam je važno. Kontaktirajte nas za sve informacije ili pošaljite žalbu kako bismo
            ...
            <div class="grid lg:grid-cols-5 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-3xl shadow-2xl p-8 card-hover h-fit">
                        <h2 class="text-3xl font-bold text-gray-800 mb-8"><?= htmlspecialchars($dynamicText['t_kontakt_42f61b_d6f9f0']['text'] ?? 'Kontakt informacije', ENT_QUOTES, 'UTF-8'); ?></h2>
                        ...
                        <div class="space-y-8">
                            <div class="flex items-start space-x-6">
                                ...
                                <div>
                                    <h3 class="text-xl font-bold text-gray-800 mb-2"><?= htmlspecialchars($dynamicText['t_kontakt_bcbdb3_f6999f']['text'] ?? 'Adresa', ENT_QUOTES, 'UTF-8'); ?></h3>
                                    <p class="text-gray-600 leading-relaxed"><?= htmlspecialchars($dynamicText['t_kontakt_1fd506_b4afdb']['text'] ?? 'Centar za umetnost i baštinu', ENT_QUOTES, 'UTF-8'); ?><br><?= htmlspecialchars($dynamicText['t_kontakt_ff250c_34702e']['text'] ?? 'Trg
                                        slobode 1', ENT_QUOTES, 'UTF-8'); ?><br><?= htmlspecialchars($dynamicText['t_kontakt_f6b0ee_f6fc64']['text'] ?? '21000 Novi Sad, Srbija', ENT_QUOTES, 'UTF-8'); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-6">
                                ...
                                <div>
                                    <h3 class="text-xl font-bold text-gray-800 mb-2"><?= htmlspecialchars($dynamicText['t_kontakt_562a55_0975cf']['text'] ?? 'Telefon', ENT_QUOTES, 'UTF-8'); ?></h3>
                                    <p class="text-gray-600 text-lg">+381 21 123 456</p>
                                    <p class="text-gray-500 text-sm"><?= htmlspecialchars($dynamicText['t_kontakt_81017f_ac7bef']['text'] ?? 'Ponedeljak - Petak: 09:00 - 17:00', ENT_QUOTES, 'UTF-8'); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-6">
                                ...
                                <div>
                                    <h3 class="text-xl font-bold text-gray-800 mb-2"><?= htmlspecialchars($dynamicText['t_kontakt_99831a_ce8ae9']['text'] ?? 'Email', ENT_QUOTES, 'UTF-8'); ?></h3>
                                    <p class="text-gray-600 text-lg"><?= htmlspecialchars($dynamicText['t_kontakt_e53d90_fe971b']['text'] ?? 'info@kulturnynexus.rs', ENT_QUOTES, 'UTF-8'); ?></p>
                                    <p class="text-gray-500 text-sm"><?= htmlspecialchars($dynamicText['t_kontakt_8caac2_c0d269']['text'] ?? 'Odgovaramo u roku od 24h', ENT_QUOTES, 'UTF-8'); ?></p>
                                </div>
                            </div>
                        </div>

                        <div class="mt-10 p-6 bg-gradient-to-br from-orange-50 to-blue-50 rounded-2xl border border-orange-100">
                            <h3 class="text-xl font-bold text-gray-800 mb-4"><?= htmlspecialchars($dynamicText['t_kontakt_fe0472_16f2a3']['text'] ?? 'Radno vreme', ENT_QUOTES, 'UTF-8'); ?></h3>
                            <div class="text-gray-700 space-y-2">
                                <div class="flex justify-between">
                                    <span class="font-medium"><?= htmlspecialchars($dynamicText['t_kontakt_226178_0286e5']['text'] ?? 'Ponedeljak - Petak:', ENT_QUOTES, 'UTF-8'); ?></span>
                                    <span>09:00 - 17:00</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="font-medium"><?= htmlspecialchars($dynamicText['t_kontakt_4e7737_d9c89f']['text'] ?? 'Subota:', ENT_QUOTES, 'UTF-8'); ?></span>
                                    <span>10:00 - 14:00</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="font-medium"><?= htmlspecialchars($dynamicText['t_kontakt_6da8db_454f27']['text'] ?? 'Nedelja:', ENT_QUOTES, 'UTF-8'); ?></span>
                                    <span class="text-red-500"><?= htmlspecialchars($dynamicText['t_kontakt_505df0_f50368']['text'] ?? 'Zatvoreno', ENT_QUOTES, 'UTF-8'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-3xl shadow-2xl p-8 card-hover">
                        ...
                        <div id="success-message" class="hidden mb-8 p-6 bg-green-50 border-2 border-green-200 rounded-2xl success-message">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="text-green-800 font-bold text-lg" id="success-title"><?= htmlspecialchars($dynamicText['t_kontakt_cca8c6_63e66c']['text'] ?? 'Vaša poruka je
                                        uspešno poslata!', ENT_QUOTES, 'UTF-8'); ?></p>
                                    <p class="text-green-700"><?= htmlspecialchars($dynamicText['t_kontakt_868762_d0ce73']['text'] ?? 'Odgovoriće vam u najkraćem mogućem roku.', ENT_QUOTES, 'UTF-8'); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form id="contact-form" class="space-y-6">
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-3"><?= htmlspecialchars($dynamicText['t_kontakt_0c831e_3539f9']['text'] ?? 'Ime i prezime *', ENT_QUOTES, 'UTF-8'); ?></label>
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-3"><?= htmlspecialchars($dynamicText['t_kontakt_6b810b_ad4848']['text'] ?? 'Email adresa *', ENT_QUOTES, 'UTF-8'); ?></label>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-3"><?= htmlspecialchars($dynamicText['t_kontakt_744619_693039']['text'] ?? 'Broj telefona', ENT_QUOTES, 'UTF-8'); ?></label>
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-3">
                                        <span id="subject-label"><?= htmlspecialchars($dynamicText['t_kontakt_b6befc_55e18c']['text'] ?? 'Naslov poruke *', ENT_QUOTES, 'UTF-8'); ?></span>
                                    </label>
                            ...
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-3">
                                    <span id="message-label"><?= htmlspecialchars($dynamicText['t_kontakt_faada7_9a1399']['text'] ?? 'Vaša poruka *', ENT_QUOTES, 'UTF-8'); ?></span>
                                </label>
                            ...
                            <div class="pt-6">
                                <button type="submit" class="w-full text-white font-bold py-5 px-8 rounded-2xl submit-btn text-lg" id="submit-button">
                                    <span class="flex items-center justify-center space-x-3">
                                        ...
                                        <span id="submit-text"><?= htmlspecialchars($dynamicText['t_kontakt_ea277e_701225']['text'] ?? 'Pošaljite poruku', ENT_QUOTES, 'UTF-8'); ?></span>
                                    </span>
                                </button>
                            </div>
                        </form>
