...
<main class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
    <section class="container mx-auto px-4 py-12">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-2"><?= htmlspecialchars($dynamicText['t_naucni-klub_710323_f84aee']['text'] ?? 'Događaji', ENT_QUOTES, 'UTF-8'); ?></h1>
            <p class="text-gray-600"><?= htmlspecialchars($dynamicText['t_naucni-klub_8c9823_7c9b57']['text'] ?? 'Istražite našu bogatu ponudu kulturnih događaja', ENT_QUOTES, 'UTF-8'); ?></p>
        </div>
