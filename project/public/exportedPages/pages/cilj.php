...
?>
    ...
    <title><?php echo htmlspecialchars($dynamicText['t_cilj_0aef9a_adfef6']['text'] ?? 'Cilj', ENT_QUOTES, 'UTF-8'); ?></title>
    ...
    <section class="relative min-h-screen flex items-center overflow-hidden pt-16 hero-gradient">
        <div class="container mx-auto px-4">
            <div class="text-center">
                <h1 class="text-4xl font-bold text-gray-900 mb-8"><?php echo htmlspecialchars($dynamicText['t_cilj_cbbeff_83218a']['text'] ?? 'Welcome', ENT_QUOTES, 'UTF-8'); ?></h1>
                <p class="text-xl text-gray-600 mb-8"><?php echo htmlspecialchars($dynamicText['t_cilj_4b313b_256d70']['text'] ?? 'This is a basic page template that can be customized further.', ENT_QUOTES, 'UTF-8'); ?></p>
            </div>
        </div>
    </section>
</main>
