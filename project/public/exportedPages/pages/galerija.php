...
?>
    ...
    <title><?= htmlspecialchars($dynamicText['t_galerija_a78a05_9fe721']['text'] ?? 'galerija', ENT_QUOTES, 'UTF-8'); ?></title>
...
<main>
    ...
    <section class="container mx-auto px-4  py-12 pt-32 ">
        ...
        <h2 class="text-3xl font-bold mb-4 text-gray-800"><?= htmlspecialchars($dynamicText['t_galerija_82752e_f0e8cb']['text'] ?? 'Kolekcija Slika', ENT_QUOTES, 'UTF-8'); ?></h2>
<p class="text-gray-600 max-w-2xl mx-auto"><?= htmlspecialchars($dynamicText['t_galerija_11bdf7_550041']['text'] ?? 'Istražite našu pažljivo odabranu kolekciju slika. Kliknite na bilo koju sliku da je pogledate u punoj veličini i da se krećete kroz galeriju.', ENT_QUOTES, 'UTF-8'); ?></p>
        ...
        <div class="pagination mt-12">
            <?php if ($page > 1): ?>
                <div class="page-item">
                    <a href="?page=<?= $page - 1 ?>" class="page-link">
                        <i class="fas fa-chevron-left mr-1"></i><?= htmlspecialchars($dynamicText['t_galerija_e3cc7c_14230d']['text'] ?? 'Prev', ENT_QUOTES, 'UTF-8'); ?></a>
                </div>
            <?php endif; ?>
            ...
            <?php if ($page < $totalPages): ?>
                <div class="page-item">
                    <a href="?page=<?= $page + 1 ?>" class="page-link"><?= htmlspecialchars($dynamicText['t_galerija_2c6479_10ac3d']['text'] ?? 'Next', ENT_QUOTES, 'UTF-8'); ?><i class="fas fa-chevron-right ml-1"></i>
                    </a>
                </div>
            <?php endif; ?>
        </div>
