...
?>
    ...
    <title><?php echo htmlspecialchars($dynamicText['t_misija_0aef9a_5a54a2']['text'] ?? 'Misija', ENT_QUOTES, 'UTF-8'); ?></title>
...
<div>
  ...
  <section class="relative min-h-screen flex items-center overflow-hidden pt-16 hero-gradient">
    ...
    <h1 class="text-5xl font-bold mb-4"><?php echo htmlspecialchars($dynamicText['t_misija_ffef92_afd2f0']['text'] ?? 'Misija naše institucije', ENT_QUOTES, 'UTF-8'); ?></h1>
