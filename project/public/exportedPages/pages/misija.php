...
?>
    ...
    <title><?= htmlspecialchars($dynamicText['t_misija_c4def6_5a54a2']['text'] ?? 'Misija', ENT_QUOTES, 'UTF-8'); ?></title>
...
<div>
  ...
  <section class="relative min-h-screen flex items-center overflow-hidden pt-16 hero-gradient">
    ...
    <h1 class="text-5xl font-bold mb-4"><?= htmlspecialchars($dynamicText['t_misija_4d6d45_afd2f0']['text'] ?? 'Misija naše institucije', ENT_QUOTES, 'UTF-8'); ?></h1>
