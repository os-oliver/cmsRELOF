...
<section class="py-20 bg-gray-50"><div class="container mx-auto px-6"><div class="text-center mb-16"><h2 class="text-4xl font-bold text-gray-800 mb-4"><?= htmlspecialchars($dynamicText['t_kgkgk_1ae95c_f33eaf']['text'] ?? 'дсадса', ENT_QUOTES, 'UTF-8'); ?></h2><p class="text-xl text-gray-600 max-w-2xl mx-auto"><?= htmlspecialchars($dynamicText['t_kgkgk_400676_06b049']['text'] ?? 'дсадас', ENT_QUOTES, 'UTF-8'); ?></p></div></div></section>
</main>
<?php
