...
<section id="promocija" class="py-20 bg-gradient-to-br from-paper to-ochre/10"><div class="container mx-auto px-4"><div class="flex flex-col lg:flex-row items-center gap-12"><div class="lg:w-1/2 relative"><div class="artistic-frame"><img src="https://images.unsplash.com/photo-1578301978693-85fa9c0320b9?auto=format&fit=crop&w=800&q=80" alt="Featured Exhibition" class="rounded-xl shadow-2xl"/></div><div class="absolute -bottom-6 -right-6 w-32 h-32 bg-terracotta rounded-full flex items-center justify-center text-paper text-5xl font-display font-bold shadow-xl">
                        50%
                    </div></div><div class="lg:w-1/2"><span class="inline-block bg-sage text-slate px-4 py-1 rounded-full text-sm font-medium mb-6"><i class="fas fa-fire mr-2"></i>Specijalna ponuda
                    </span><h2 class="text-4xl font-display font-bold text-slate mb-6"><h2 class="text-4xl font-display font-bold text-slate mb-6"><span class="block"><?=$dynamicText[26]?></span><span class="block text-terracotta"><?=$dynamicText[27]?></span></h2></h2><p class="text-lg text-slate-700 mb-6 leading-relaxed"><p class="text-lg text-slate-700 mb-6 leading-relaxed"><?=$dynamicText[28]?></p></p><div class="flex flex-wrap gap-4 mb-8"><div class="flex items-center"><i class="fas fa-calendar-day text-terracotta text-xl mr-3"></i><div><p class="text-sm text-slate-600"><p class="text-sm text-slate-600"><?=$dynamicText[29]?></p></p><p class="font-medium"><p class="font-medium"><?=$dynamicText[30]?></p></p></div></div><div class="flex items-center"><i class="fas fa-clock text-terracotta text-xl mr-3"></i><div><p class="text-sm text-slate-600"><p class="text-sm text-slate-600"><?=$dynamicText[31]?></p></p><p class="font-medium"><p class="font-medium"><?=$dynamicText[32]?></p></p></div></div><div class="flex items-center"><i class="fas fa-map-marker-alt text-terracotta text-xl mr-3"></i><div><p class="text-sm text-slate-600"><p class="text-sm text-slate-600"><?=$dynamicText[33]?></p></p><p class="font-medium"><p class="font-medium"><?=$dynamicText[34]?></p></p></div></div></div><div class="flex flex-wrap gap-4"><button class="bg-gradient-to-r from-terracotta to-ochre text-paper px-8 py-4 rounded-full font-medium hover:opacity-90 transition-all flex items-center shadow-lg"><i class="fas fa-ticket-alt mr-3"></i>
                            Rezerviši karte
                        </button><button class="border-2 border-terracotta text-terracotta px-8 py-4 rounded-full font-medium hover:bg-terracotta/10 transition-all flex items-center"><i class="fas fa-info-circle mr-3"></i>
                            Saznaj više
