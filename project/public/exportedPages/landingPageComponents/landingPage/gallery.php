...
?>
<section id="gallery" class="py-20 bg-white"><div class="container mx-auto px-4"><div class="text-center mb-16"><h2 class="text-4xl font-display font-bold text-slate mb-4"><h2 class="text-4xl font-display font-bold text-slate mb-4"><?=$dynamicText[35]?></h2></h2><p class="text-lg text-slate-600 max-w-2xl mx-auto"><p class="text-lg text-slate-600 max-w-2xl mx-auto"><?=$dynamicText[36]?></p></p></div><div id="galleryCards" class="gallery-grid gap-6"><?php $__i = 0; foreach ($images as $images_item): if ($__i++ >= 6) break; ?>
