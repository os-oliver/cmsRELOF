...
<body class="bg-gray-50 font-sans overflow-x-hidden">
    ...
    <div class="floating-orb w-72 h-72 bg-gradient-to-r from-purple-400 to-pink-400 opacity-10" style="top: 10%; right: 10%;"></div>
    <div class="floating-orb w-96 h-96 bg-gradient-to-r from-blue-400 to-cyan-400 opacity-10" style="bottom: 10%; left: 10%; animation-delay: -3s;"></div>
        ...
        <div class="sidebar text-white w-64 fixed min-h-screen z-10">
            <div class="p-6 border-b border-gray-700">
                <h1 class="text-2xl font-bold flex items-center">
                    ...
                    <span class="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Admin Panel</span>
                </h1>
            </div>
            <nav class="mt-6">
                <ul class="space-y-2">
            ...
            <div class="absolute bottom-0 w-full p-6 border-t border-gray-700">
                <div class="flex items-center glass-effect rounded-xl p-4">
                    <div class="w-12 h-12 rounded-full bg-gradient-to-r from-primary to-purple-500 flex items-center justify-center animate-bounce-gentle">
        ...
        <div class="content-area ml-64 flex-1 min-h-screen">
            ...
            <div class="glass-effect p-6 flex justify-between items-center sticky top-0 z-20">
                <div class="flex items-center">
                    ...
                    <h2 class="text-2xl font-bold hidden md:inline bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
                        Uređivač Stranica
                    </h2>
                </div>
                <div class="flex items-center space-x-6">
                    <div class="relative">
                        <i class="fas fa-bell text-gray-600 text-xl hover:text-primary transition-colors cursor-pointer"></i>
                        <span class="notification-badge absolute -top-2 -right-2 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">3</span>
                    </div>
                    <div class="relative">
                        <i class="fas fa-envelope text-gray-600 text-xl hover:text-primary transition-colors cursor-pointer"></i>
                        <span class="notification-badge absolute -top-2 -right-2 bg-gradient-to-r from-primary to-purple-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">5</span>
                    </div>
            ...
            <div class="p-6">
                    ...
                    <div class="stats-card rounded-2xl shadow-xl p-6 animate-fade-in">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">24</p>
                            </div>
                            <div class="w-14 h-14 rounded-2xl bg-gradient-to-r from-blue-400 to-blue-600 flex items-center justify-center shadow-lg">
                    ...
                    <div class="stats-card rounded-2xl shadow-xl p-6 animate-fade-in" style="animation-delay: 0.1s;">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-3xl font-bold bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">18</p>
                            </div>
                            <div class="w-14 h-14 rounded-2xl bg-gradient-to-r from-green-400 to-green-600 flex items-center justify-center shadow-lg">
                    ...
                    <div class="stats-card rounded-2xl shadow-xl p-6 animate-fade-in" style="animation-delay: 0.2s;">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-3xl font-bold bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent">1.2K</p>
                            </div>
                            <div class="w-14 h-14 rounded-2xl bg-gradient-to-r from-purple-400 to-purple-600 flex items-center justify-center shadow-lg">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1">
                        <div class="glass-effect rounded-2xl shadow-2xl p-6 animate-slide-up">
                            <div class="flex justify-between items-center mb-6">
                                <h3 class="text-xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">Lista Stranica</h3>
                            ...
                            <div class="space-y-4 max-h-[600px] overflow-y-auto">
                                <!-- Page Cards -->
                                <div class="page-card rounded-xl p-6 cursor-pointer border-2 border-transparent hover:border-primary/30">
                                    <div class="flex justify-between items-start mb-3">
                                        <h4 class="font-bold text-gray-800">Početna Strana</h4>
                                        <span class="bg-gradient-to-r from-green-400 to-green-600 text-white text-xs px-3 py-1 rounded-full font-medium">Aktivna</span>
                                    </div>
                                ...
                                <div class="page-card rounded-xl p-6 cursor-pointer border-2 border-transparent hover:border-primary/30">
                                    <div class="flex justify-between items-start mb-3">
                                        ...
                                        <span class="bg-gradient-to-r from-yellow-400 to-orange-500 text-white text-xs px-3 py-1 rounded-full font-medium">U izradi</span>
                                    </div>
                                ...
                                <div class="page-card rounded-xl p-6 cursor-pointer border-2 border-transparent hover:border-primary/30">
                                    <div class="flex justify-between items-start mb-3">
                                        ...
                                        <span class="bg-gradient-to-r from-red-400 to-red-600 text-white text-xs px-3 py-1 rounded-full font-medium">Neaktivna</span>
                                    </div>
                    ...
                    <div class="lg:col-span-2">
                        <div class="editor-area rounded-2xl shadow-2xl p-8 animate-slide-up" style="animation-delay: 0.2s;">
                            <div class="flex justify-between items-center mb-8">
                                <h3 class="text-xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">Uređivač Stranica</h3>
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" value="Početna Strana" class="input-field w-full p-4 rounded-xl font-medium">
                                </div>
                                
                                <div>
                                    <label class="block text-gray-700 font-semibold mb-3">URL Adresa</label>
                                    <div class="flex rounded-xl overflow-hidden">
                                        <span class="flex items-center bg-gradient-to-r from-gray-100 to-gray-200 border-2 border-r-0 border-gray-300 px-6 font-medium text-gray-600">https://sajt.com</span>
                                        <input type="text" value="/index" class="input-field flex-1 p-4 border-l-0 rounded-l-none font-medium">
                                    </div>
                                </div>
                                ...
                                <div class="pt-4">
                                    <button onclick="window.location.href='admin.php?page=1'" class="btn-primary text-white px-8 py-4 rounded-xl font-medium text-lg">
