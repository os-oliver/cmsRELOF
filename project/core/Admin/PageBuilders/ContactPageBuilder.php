                        ...
                        <div class="space-y-8">
                            <div class="flex items-start space-x-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 leading-relaxed">Sedme brigade br. 18
                                    <br>18330 Babušnica, Srbija</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-lg">+381 10 385 202</p>
                                    <p class="text-gray-500 text-sm">Radnim danima: 06:00 - 15:00</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-lg" data-translate="off">pubabusnica@mts.rs</p>
                                    <p class="text-gray-600 text-lg" data-translate="off">sekretar.vrticbb@gmail.com</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-10 p-6 bg-gradient-to-br from-orange-50 to-blue-50 rounded-2xl border border-orange-100">
                            ...
                            <div class="text-gray-700 space-y-2">
                                <div class="flex justify-between">
                                    <span class="font-medium">Radnim danima:</span>
