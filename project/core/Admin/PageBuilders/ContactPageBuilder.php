                        ...
                        <div class="space-y-8">
                            <div class="flex items-start space-x-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 leading-relaxed">Galerija Lazar Vozarević<br>
                                    Gradski park 4,<br>
                                    22000 Sremska Mitrovica, Srbija</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-lg">022/621-492</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-lg" data-translate="off">galerijalazarvozarevic@gmail.com</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-10 p-6 bg-gradient-to-br from-orange-50 to-blue-50 rounded-2xl border border-orange-100">
                            ...
                            <div class="text-gray-700 space-y-2">
                                <div class="flex justify-between">
                                    <span class="font-medium">Utorak - Petak:</span>
