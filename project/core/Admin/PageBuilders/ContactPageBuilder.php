                        ...
                        <div class="space-y-8">
                            <div class="flex items-start space-x-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 leading-relaxed">Centar za stručno usavršavanje Niš<br>
                                    Pariske Komune bb,<br>18000 Niš, Srbija</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-lg">+381 (18) 202 300; 202-420</p>
                                    <p class="text-gray-500 text-sm">Ponedeljak - Petak: 08:00 - 17:00</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-lg" data-translate="off">info@rcnis.edu.rs</p>
                                </div>
                            </div>
                        </div>
