...
class TestBuilder extends BasePageBuilder
{
...
<div>
  ...
  <section class="relative min-h-screen flex items-center overflow-hidden pt-16 hero-gradient">
    ...
    <h1 class="text-5xl font-bold mb-4">Neki naslov forsiram</h1>
    <img src=""/>
    <h2 class="text-3xl mx-5 italic mb-4 text-justify">neki opis</h1>
    </div>
  </section>
</main>
HTML;
