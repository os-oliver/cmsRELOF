...
class PublikacijePageBuilder extends BasePageBuilder
{
...
PHP;
    ...
    $cardTemplate = <<<'PHP'
        <div class="glass-card rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col">
            ...
            <p class="text-secondary_text text-sm leading-relaxed mb-4">
                {{tekst}}
            </p>

            <div class="text-xs text-gray-500 mb-5 flex items-center">
...
<main class="bg-background min-h-screen">
    <section class="container mx-auto px-4 py-12">
        <div class="mb-8">
            <h1 class="text-3xl font-heading font-bold text-primary mb-2">Publikacije</h1>
            <p class="text-secondary_text">Publikacije obrazovnog centra posvećene unapređenju znanja i stručnog razvoja.</p>
        </div>
