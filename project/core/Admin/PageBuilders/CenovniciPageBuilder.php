...
class CenovniciPageBuilder extends BasePageBuilder
{
  ...
  private function initializeTexts(): void
  {
    ...
    $latinTexts = [
      'download_pricelist' => 'Preuzmi cenovnik',
...
{
    $item = \App\Utils\HashMapTransformer::remapToOldItemStructure($item, $locale);
...
<main class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
    <section class="container mx-auto px-4 py-12">
        <div class="mb-8 font-body text-secondary_text text-center">
            <h1 class="text-3xl font-heading text-primary_text mb-2">Cenovnik</h1>
            <p class="font-heading2">Pregled dostupnih cenovnika.</p>
        </div>
