...
<main>
  ...
  <section class="relative min-h-screen flex items-center overflow-hidden pt-16 bg-background">
    ...
    <div class="relative z-10 w-full max-w-5xl mx-auto text-center font-body text-secondary_text">
      ...
      <div class="font-body mb-4 text-center">Regionalni centri za profesionalni razvoj zaposlenih u obrazovanju uspostavljeni su kroz projekat Stručnog usavršavanja obrazovnog kadra <span data-translate="off">&nbsp;(Professional Development Project - PDP)</span>, zahvaljujući memorandumu o razumevanju, potpisanom 24. jula 2003, između vlada Švajcarske - Agencije za razvoj i saradnju <span data-translate="off">&nbsp;(SDC)&nbsp;</span> i Republike Srbije - Ministarstva prosvete.</div>
      <p class="font-body mb-8 text-center">
      ...
      <ul class="list-disc mb-8 text-left">
