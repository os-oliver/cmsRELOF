...
<main class="bg-background">
    <div class="text-center px-2 pt-32">
        ...
        <p class="text-lg text-gray-600 max-w-3xl mx-auto mb-10 font-body">Preuzmite sva potrebna dokumenta. Slažemo ih po kategorijama radi lakšeg pronalaženja.</p>
