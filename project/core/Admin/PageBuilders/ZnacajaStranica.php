      ...
      <article>
          ...
          <ol class="list-decimal pl-6 space-y-2">
            ...
            <li><strong>Pošaljite popunjen zahtev</strong>&nbsp;na adresu elektronske pošte:&nbsp;
              <a data-translate="off" class="text-accent hover:text-accent_hover underline-offset-2 hover:underline"
                 href="mailto:milenkosu63@gmail.com?subject=Zahtev%20za%20pristup%20informacijama%20od%20javnog%20zna%C4%8Daja">
                 milenkosu63@gmail.com
        ...
        <section class="mt-4">
          ...
          <div class="bg-surface border border-secondary/20 rounded-2xl p-6">
            <p><strong>Lice ovlašćeno za zaštitu podataka o ličnosti</strong><br>Milenko Šugin<a class="text-accent hover:text-accent_hover" data-translate="off" href="mailto:milenkosu63@gmail.com">milenkosu63@gmail.com</a></p>
          </div>
        </section>
      </article>
          ...
          <div class="bg-surface border border-secondary/20 rounded-2xl p-6">
            ...
            <div class="mt-3">
              <div class="flex items-center justify-between gap-2 bg-white border border-secondary/30 rounded-xl px-3 py-2">
                <span class="truncate text-primary_text" data-translate="off">milenkosu63@gmail.com</span>
                <button class="inline-flex items-center gap-2 rounded-full px-3 py-2 bg-secondary hover:bg-secondary_hover text-white font-semibold"
                        onclick="navigator.clipboard.writeText('milenkosu63@gmail.com')">
                  Kopiraj
                </button>
              </div>
              <p class="mt-2">
