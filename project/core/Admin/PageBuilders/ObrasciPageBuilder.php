...
class ObrasciPageBuilder extends BasePageBuilder
{
    ...
    private function initializeTexts(): void
    {
        ...
        $latinTexts = [
            'search_placeholder' => 'Pretraži obrasce...',
 ...
 function cardRender(array $item, array $fieldLabels, string $locale, array $texts = [], int $descMaxLength = 250, $cardTemplate = ''): string
{
    ...
    $replacements = [
        ...
        '{{itemId}}' => $itemId,
        '{{formDetails}}' => $texts['form_details'] ?? 'Details'
    ];
...
$pageDescription = 'Pregled svih obrazaca';
