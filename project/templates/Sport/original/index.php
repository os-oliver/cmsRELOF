...
<head>
    ...
    <meta name="description"
        content="Sportski centar Olympia - ponuda sportskih sadržaja i treninga za sve uzraste. Pratite najnovije rezultate i upišite se!">
...
<body class="bg-gray-50 text-gray-800">
    ...
    <header class="sticky top-0 z-50 bg-white shadow-md">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h1 class="text-2xl font-bold text-secondary">SPORTSKI CENTAR <span
                            class="text-primary">OLYMPIA</span></h1>
    ...
    <section id="pocetna" class="hero text-white py-20 md:py-32">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl mb-10 max-w-3xl mx-auto">Pridruži se vodećem sportskom centru sa najboljim
                trenerima, savremenim terenima i uzbudljivim takmičenjima</p>
            <div class="flex flex-col md:flex-row justify-center gap-4">
                <a href="#clanstvo"
                    class="bg-primary hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full text-lg transition duration-300 transform hover:scale-105">POSTANI
                    ČLAN</a>
                <a href="#treninzi"
                    class="bg-white hover:bg-gray-100 text-black text-secondary font-bold py-3 px-8 rounded-full text-lg transition duration-300 transform hover:scale-105">REZERVIŠI
                    TRENING</a>
            </div>
        </div>
    </section>
    ...
    <section id="o-nama" class="py-16">
        <div class="container mx-auto px-4">
            ...
            <p class="text-gray-600 mb-12 max-w-3xl">Sportski centar Olympia osnovan je 1998. godine sa ciljem
                promovisanja sporta i zdravog načina života za sve uzraste.</p>
            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div class="md:w-1/2">
                    ...
                    <p class="text-gray-700 mb-6">Olympia je više od sportskog centra - mi smo zajednica entuzijasta
                        posvećenih razvoju sporta. Naša misija je da kroz kvalitetne programe, savremenu infrastrukturu
                        i stručno osoblje pružimo najbolje uslove za rekreaciju i takmičenje.</p>
                    <p class="text-gray-700 mb-6">Tokom proteklih 25 godina, iz naše škole je izašlo više od 50
                        reprezentativaca u različitim sportovima, a naši timovi osvojili su brojna priznanja na
                        nacionalnom i međunarodnom nivou.</p>
    ...
    <section id="objekti" class="py-16 bg-gray-100">
        <div class="container mx-auto px-4">
            ...
            <p class="text-gray-600 mb-12 max-w-3xl">Istražite naše vrhunsko opremljene sportski objekte dizajnirane za
                profesionalne sportiste i rekreativce.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="event-card bg-white rounded-xl overflow-hidden shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Savremeni stadion sa atletskom stazom i fudbalskim terenom.
                            Kapacitet: 5,000 gledalaca.</p>
                ...
                <div class="event-card bg-white rounded-xl overflow-hidden shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Višenamenska sportska dvorana za odbojku, košarku, rukomet i
                            badminton.</p>
                        <ul class="space-y-2 mb-4">
                            <li class="flex items-center">
                                <i class="fas fa-check-circle text-primary mr-2"></i>
    ...
    <section id="treninzi" class="py-16">
        <div class="container mx-auto px-4">
            ...
            <p class="text-gray-600 mb-12 max-w-3xl">Pronađite savršen trening za sebe u našoj širokoj ponudi sportskih
                aktivnosti za sve uzraste.</p>
            ...
            <div class="mb-12">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-2">
                            <button class="p-2 rounded-full hover:bg-gray-100"><i
                ...
                <div class="mb-8">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <button class="px-4 py-2 bg-secondary text-black rounded-full font-semibold">Svi
                            sportovi</button>
                        <button
                            class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-full font-semibold">Fudbal</button>
                        <button
                            class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-full font-semibold">Košarka</button>
                        <button
                            class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-full font-semibold">Odbojka</button>
                        <button
                            class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-full font-semibold">Tenis</button>
                        <button
                            class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-full font-semibold">Atletika</button>
                    </div>
                </div>
                    ...
                    <table class="min-w-full bg-white rounded-xl shadow-lg">
                        ...
                        <tbody>
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td class="py-4 px-4">
                                    <button
                                        class="bg-primary hover:bg-red-700 text-black px-4 py-1 rounded-full text-sm">Rezerviši</button>
                                </td>
                            </tr>
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-600 text-sm mt-2">Licencirani UEFA A trener sa 15 godina iskustva u radu
                                sa omladincima.</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-600 text-sm mt-2">Bivša reprezentativka, vodi seniorski tim žena i školu
                                košarke.</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-600 text-sm mt-2">ATP licencirani trener, specijalista za teniske škole
                                za decu i odrasle.</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-600 text-sm mt-2">Diplomirani nutricionista i personalni trener sa 10
                                godina iskustva.</p>
                        </div>
                    </div>
                </div>
    ...
    <section id="takmicenja" class="py-16 bg-gray-100">
        <div class="container mx-auto px-4">
            ...
            <p class="text-gray-600 mb-12 max-w-3xl">Pratite aktuelna takmičenja, rezultate i najave sportskih događaja
                u našem centru.</p>
                            ...
                            <div class="flex flex-col md:flex-row gap-6">
                                ...
                                <div class="md:w-3/4">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <span
                                            class="bg-primary text-black px-3 py-1 rounded-full text-sm font-bold">LIVE</span>
                                    </div>
                                    <div class="flex items-center text-gray-600 my-2">
                                        <i class="far fa-calendar mr-2"></i>
                                        <span>15. Jul 2023 | 18:00</span>
                                    </div>
                                    <p class="text-gray-700 mb-4">Finalna utakmica gradske fudbalske lige između Olympia
                                        FC i Spartak.</p>
                                    <div class="flex justify-between items-center">
                                        ...
                                        <button
                                            class="bg-secondary hover:bg-blue-900 text-black px-4 py-2 rounded-full">Rezerviši
                                            kartu</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="event-card bg-white rounded-xl shadow-lg p-6">
                            <div class="flex flex-col md:flex-row gap-6">
                                ...
                                <div class="md:w-3/4">
                                    ...
                                    <p class="text-gray-700 mb-4">Godišnji košarkaški turnir u kome učestvuju 24 tima iz
                                        cele regije.</p>
                                    <div class="flex justify-between items-center">
                                        <div class="flex items-center">
                                            <i class="fas fa-map-marker-alt text-primary mr-2"></i>
                                        ...
                                        <button
                                            class="bg-secondary hover:bg-blue-900 text-black px-4 py-2 rounded-full">Prijavi
                                            tim</button>
                                    </div>
                                </div>
                            </div>
    ...
    <section id="clanstvo" class="py-16">
        <div class="container mx-auto px-4">
            ...
            <p class="text-gray-600 mb-12 max-w-3xl">Postanite deo Olympia porodice i iskoristite sve prednosti našeg
                članstva.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                ...
                <div class="membership-card bg-white rounded-xl shadow-xl border-t-4 border-primary p-8">
                    ...
                    <button
                        class="w-full bg-primary hover:bg-red-700 text-black font-bold py-3 rounded-full transition duration-300">IZABERI
                        PAKET</button>
                </div>

                <!-- Membership Card 2 -->
                <div class="membership-card bg-white rounded-xl shadow-xl border-t-4 border-secondary p-8 relative">
                    <div class="absolute top-0 right-0 bg-secondary text-black px-4 py-1 rounded-bl-lg">NAJPOPULARNIJI
                    </div>
                    ...
                    <button
                        class="w-full bg-secondary hover:bg-blue-900 text-black font-bold py-3 rounded-full transition duration-300">IZABERI
                        PAKET</button>
                </div>
                ...
                <div class="membership-card bg-white rounded-xl shadow-xl border-t-4 border-accent p-8">
                    ...
                    <button
                        class="w-full bg-accent hover:bg-yellow-700 text-black font-bold py-3 rounded-full transition duration-300">IZABERI
                        PAKET</button>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                ...
                <form class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 flex items-center">
                        ...
                        <label for="terms" class="text-gray-700">Slažem se sa uslovima članstva i obradom ličnih
                            podataka</label>
                    </div>
                    <div class="md:col-span-2">
                        <button
                            class="bg-primary hover:bg-red-700 text-black font-bold py-3 px-8 rounded-full text-lg transition duration-300">POŠALJI
                            PRIJAVU</button>
                    </div>
                </form>
            </div>
    ...
    <section class="py-16 bg-gray-100">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mt-10">
                <button
                    class="bg-secondary hover:bg-blue-900 text-black font-bold py-3 px-8 rounded-full text-lg transition duration-300">POGLEDAJTE
                    VIŠE</button>
            </div>
        </div>
    </section>
    ...
    <section id="kontakt" class="py-16">
        <div class="container mx-auto px-4">
            ...
            <p class="text-gray-600 mb-12 max-w-3xl">Dođite nas posetite ili nas kontaktirajte za sve informacije koje
                su vam potrebne.</p>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="mb-4">Vodeći sportski centar sa tradicijom i najsavremenijim sadržajima za sve uzraste.
                    </p>
                ...
                <div>
                    ...
                    <form class="flex">
                        ...
                        <button class="bg-primary hover:bg-red-700 px-4 py-2 rounded-r-lg"><i
