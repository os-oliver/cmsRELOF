...
<head>
    ...
    <title>Obrazovna ustanova</title>
    <link
...
<body class="bg-background font-body text-secondary_text min-h-screen overflow-x-hidden">
        ...
        <div class="container mx-auto px-4 flex justify-between items-center">
            ...
            <a href="/" class="flex items-center space-x-3 flex-shrink-0">
                <div class="w-16 h-16 rounded-xl flex items-center justify-center text-white text-2xl mr-4">
                    <img src="/assets/img/duga-logo.jpg" alt="" style="width:75px;height:auto;" />
                </div>
                <div class="hidden sm:block">
                    <h1 class="text-xl lg:text-2xl font-heading text-primary font-bold tracking-wider">DUGA</h1>
                    <p class="text-xs text-barn_red tracking-widest hidden md:block">CENTAR ZA DECU I OMLADINU</p>
                </div>
    ...
    <section class="slider-item hero relative flex items-center z-10 w-full h-[600px] overflow-hidden">
        <img src="/assets/img/duga-bkg.jpg" alt="Pozadinska slika za slider"
            class="absolute inset-0 w-full h-full object-cover z-10">

        <div class="max-w-6xl mx-auto px-4 py-20 text-center relative z-30 text-white w-full">
            <div class="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                <img src="/assets/img/duga-logo-big.jpg" alt="Duga" width="150" />
            </div>
    ...
    <footer class="bg-primary/90 text-white pt-20 pb-10">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                <div>
                    <div class="flex items-center mb-6">
                        <div class="w-16 h-16 rounded-xl flex items-center justify-center text-white text-2xl mr-4">
                            <img src="/assets/img/duga-logo.jpg" alt="Duga" style="width:75px;height:auto;" />
                        </div>
                        <h3 class="text-xl font-heading font-bold">CENTAR ZA DECU I OMLADINU "DUGA"</h3>
                    </div>
                    <div class="flex space-x-3">
                        <a href="https://www.facebook.com/p/Centar-Duga-100057560855727/"
                        ...
                        <a href="https://www.instagram.com/duga.centar/?hl=en"
                            class="w-10 h-10 rounded-full bg-primary_text/90 hover:bg-accent hover:text-black flex items-center justify-center text-white transition-colors">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            ...
                            <span>Kej 37. sandžačke divizije A<br />36300 Novi Pazar</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-phone text-secondary mt-1 mr-3"></i>
                            <span>+381 20 317 390</span>
                        </li>
                        <li class="flex items-start">
                ...
                <div>
                    ...
                    <div class="rounded-xl overflow-hidden aspect-w-16 aspect-h-9">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.49792343992!2d20.51354527614975!3d43.14059367113105!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475629378c8d276f%3A0x693aaffb28807c4e!2sCentar%20Duga!5e1!3m2!1sen!2srs!4v1763882910292!5m2!1sen!2srs"
            ...
            <div class="pt-8 text-center text-white text-sm">
                <p>&copy; 2023 Centar za decu i omladinu Duga. Sva prava zadržana.</p>
            </div>
        </div>
    </footer>
