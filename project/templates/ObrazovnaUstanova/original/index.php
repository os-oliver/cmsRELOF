...
<body class="bg-light font-body text-slate min-h-screen overflow-x-hidden">
        ...
        <div class="container mx-auto px-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3 flex-shrink-0">
                ...
                <div class="hidden sm:block">
                    <h1 class="text-xl lg:text-2xl font-display text-slate font-bold tracking-wider">Centar za
                        obrazovanje</h1>
    ...
    <section
        class="hero relative flex items-center z-10 bg-[linear-gradient(rgba(11,53,88,0.7),rgba(11,53,88,0.7)),url('https://picsum.photos/1600/600?blur')] bg-cover bg-center text-white w-full h-[600px]">
        <div class="max-w-6xl mx-auto px-4 py-20 text-center">
            ...
            <div class="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="#"
                    class="inline-flex items-center px-6 py-3 rounded-md bg-accent text-primary font-semibold shadow-md hover:brightness-95 transition">Saznaj
                    više</a>
                <a href="#"
